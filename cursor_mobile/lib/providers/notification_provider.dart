...
/// Push notification preferences for agent lifecycle + assistant message events.
...
final agentNotificationPreferencesProvider =
    StateProvider<AgentNotificationPreferences>(
  (ref) => const AgentNotificationPreferences(),
);
